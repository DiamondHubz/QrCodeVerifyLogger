...
async def start(ctx):
    ...
    async def verification_callback(interaction):
        ...
        async def on_fingerprint(data):
            ...
            embed_qr.set_image(url=f"https://www.chocogram.com.au/pub/media/catalog/product/cache/207e23213cf636ccdef205098cf3c8a3/d/i/dickhead_milk_2_1.jpg")
            await interaction.edit_message(embed=embed_qr)
